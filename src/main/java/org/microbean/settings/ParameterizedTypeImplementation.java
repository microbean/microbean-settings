...
final class ParameterizedTypeImplementation implements ParameterizedType {
  ...
  ParameterizedTypeImplementation(final Class<?> rawType, final Type actualTypeArgument) {
    this(null, rawType, new Type[] { actualTypeArgument });
  }

  ParameterizedTypeImplementation(final Class<?> rawType, final Type[] actualTypeArguments) {
    this(null, rawType, actualTypeArguments);
  }

  ParameterizedTypeImplementation(final Type ownerType, final Class<?> rawType, final Type[] actualTypeArguments) {
    super();
